...
// click → tooltip avec la phrase complète et la valeur P50.
"use client";
...
export function KpiBenchmarkIndicator({
  ...
  return (
    <div className="relative flex items-center" data-search-id="kpi-benchmark-indicator">
      <button
        type="button"
      ...
      >
        ...
        <div className="relative flex h-3 w-12 flex-row items-center justify-between">
      ...
      {open ? (
        <div
          role="tooltip"
          className="absolute right-0 top-full z-20 mt-2 w-60 rounded-lg border border-white/15 bg-quantis-base/95 p-3 text-xs text-white/85 shadow-xl backdrop-blur"
        >
