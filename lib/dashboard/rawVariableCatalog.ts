...
const BILAN: RawVariableDefinition[] = [
  ...
  // Actif circulant
  { id: "raw:total_stocks", label: "Total stocks", shortLabel: "Stocks", source: "bilan", field: "total_stocks" },
  ...
  { id: "raw:dispo", label: "Disponibilités", shortLabel: "Dispo.", source: "bilan", field: "dispo" },
  ...
  // Capitaux propres
  { id: "raw:capital", label: "Capital social", shortLabel: "Capital", source: "bilan", field: "capital" },
  ...
  { id: "raw:res_net", label: "Résultat de l'exercice", shortLabel: "Résultat", source: "bilan", field: "res_net" },
  { id: "raw:total_cp", label: "Capitaux propres", shortLabel: "CP", source: "bilan", field: "total_cp" },
  { id: "raw:total_prov", label: "Provisions pour risques", shortLabel: "Provisions", source: "bilan", field: "total_prov" },
  // Dettes
  ...
  { id: "raw:total_dettes", label: "Total dettes", shortLabel: "Dettes", source: "bilan", field: "total_dettes" },
...
const CDR: RawVariableDefinition[] = [
  ...
  { id: "raw:prod_vendue", label: "Production vendue totale", shortLabel: "Prod. vendue", source: "compte_resultat", field: "prod_vendue" },
  { id: "raw:prod_biens", label: "Production vendue — Biens", shortLabel: "Prod. biens", source: "compte_resultat", field: "prod_biens" },
  { id: "raw:prod_serv", label: "Production vendue — Services", shortLabel: "Prod. services", source: "compte_resultat", field: "prod_serv" },
  ...
  { id: "raw:autres_prod_expl", label: "Autres produits d'exploitation", shortLabel: "Autres prod.", source: "compte_resultat", field: "autres_prod_expl" },
  { id: "raw:total_prod_expl", label: "Total produits d'exploitation", shortLabel: "Total produits", source: "compte_resultat", field: "total_prod_expl" },
  ...
  { id: "raw:var_stock_march", label: "Variation de stocks marchandises", shortLabel: "Var. stocks march.", source: "compte_resultat", field: "var_stock_march" },
  { id: "raw:var_stock_mp", label: "Variation de stocks matières premières", shortLabel: "Var. stocks MP", source: "compte_resultat", field: "var_stock_mp" },
  { id: "raw:ace", label: "Autres charges externes", shortLabel: "Charges ext.", source: "compte_resultat", field: "ace" },
  { id: "raw:impots_taxes", label: "Impôts et taxes", shortLabel: "Impôts & taxes", source: "compte_resultat", field: "impots_taxes" },
  { id: "raw:salaires", label: "Rémunérations du personnel", shortLabel: "Salaires", source: "compte_resultat", field: "salaires" },
  { id: "raw:charges_soc", label: "Charges sociales", shortLabel: "Charges soc.", source: "compte_resultat", field: "charges_soc" },
  { id: "raw:dap", label: "Dotations aux amortissements", shortLabel: "DAP", source: "compte_resultat", field: "dap" },
  { id: "raw:dprov", label: "Dotations aux provisions", shortLabel: "D. provisions", source: "compte_resultat", field: "dprov" },
  ...
  { id: "raw:total_charges_expl", label: "Total charges d'exploitation", shortLabel: "Total charges", source: "compte_resultat", field: "total_charges_expl" },
  { id: "raw:ebit", label: "Résultat d'exploitation", shortLabel: "Rex", source: "compte_resultat", field: "ebit" },
  ...
  { id: "raw:prod_excep", label: "Produits exceptionnels", shortLabel: "Prod. excep.", source: "compte_resultat", field: "prod_excep" },
  { id: "raw:charges_excep", label: "Charges exceptionnelles", shortLabel: "Charges excep.", source: "compte_resultat", field: "charges_excep" },
  { id: "raw:is_impot", label: "Impôt sur les bénéfices", shortLabel: "IS", source: "compte_resultat", field: "is_impot" },
  { id: "raw:resultat_exercice", label: "Résultat de l'exercice", shortLabel: "Résultat", source: "compte_resultat", field: "resultat_exercice" }
];
