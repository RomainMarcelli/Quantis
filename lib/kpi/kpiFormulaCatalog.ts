...
export const KPI_FORMULA_CATALOG: KpiFormulaDefinition[] = [
  { key: "tcam", label: "TCAM", formula: "((ca / ca_start)^(1/n) - 1) * 100 (multi-annees)" },
  { key: "ca", label: "Chiffre d'affaires", formula: "ventes_march + prod_vendue (fallback total_prod_expl)" },
  ...
  { key: "mscv", label: "MSCV", formula: "ca - charges_var" },
  { key: "tmscv", label: "TMSCV", formula: "mscv / ca" },
  ...
  { key: "ratio_immo", label: "Ratio immo", formula: "total_actif_immo_net / total_actif_immo_brut" },
  { key: "bfr", label: "BFR", formula: "(total_stocks + creances) - fournisseurs" },
  ...
  { key: "fte", label: "Cash reel", formula: "caf - (bfr_n - bfr_n-1)" },
  ...
  { key: "etat_materiel_indice", label: "État du matériel (indice)", formula: "(total_actif_immo_net / total_actif_immo_brut) * 100" },
